...
plot(dateNtime, subData$Voltage, type = "l", xlab = "", ylab = "Voltage", lwd = 1)
...
plot(dateNtime, subData$Global_reactive_power, type = "l", xlab = "", ylab = "Global Reactive Power", lwd = 1)
